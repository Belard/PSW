...
class Actions {
    ...
    void set_house_price(int sale_price) {
      house_price = sale_price;
    }
    int get_house_price() {
      return house_price;
    }
    ...
    void set_owner(player_list owner) {
        ownership = owner;
    }
    ...
    void set_mortage_price(int sale_price) {
      mortage_price = sale_price;
    }
    int get_mortage_price() {
      return mortage_price;
    }
    double get_unmortage_price() {
      return mortage_price*1.1;
    }
    boolean get_mortage() {
      return mortage;
    }
...
class Properties {
    ...
    public void setup()   {
        ...
        brown_1.set_house_price(50);
        brown_1.set_mortage_price(30);
        ...
        brown_2.set_house_price(50);
        brown_2.set_mortage_price(30);
        ...
        cyan_1.set_house_price(50);
        cyan_1.set_mortage_price(50);
        ...
        cyan_2.set_house_price(50);
        cyan_2.set_mortage_price(50);
        ...
        cyan_3.set_house_price(50);
        cyan_3.set_mortage_price(60);
        ...
        purple_1.set_house_price(100);
        purple_1.set_mortage_price(70);
        ...
        purple_2.set_house_price(100);
        purple_2.set_mortage_price(70);
        ...
        purple_3.set_house_price(100);
        purple_3.set_mortage_price(80);
        ...
        orange_1.set_house_price(100);
        orange_1.set_mortage_price(90);
        ...
        orange_2.set_house_price(100);
        orange_2.set_mortage_price(90);
        ...
        orange_3.set_house_price(100);
        orange_3.set_mortage_price(100);
        ...
        red_1.unset_mortage();
        red_1.set_house_price(150);
        red_1.set_mortage_price(110);
        ...
        red_1.set_rent(6, 18);
        red_2.unset_mortage();
        red_2.set_house_price(150);
        red_2.set_mortage_price(110);
        ...
        red_2.set_rent(6, 18);
        red_3.unset_mortage();
        red_3.set_house_price(150);
        red_3.set_mortage_price(120);
        ...
        yellow_1.set_house_price(150);
        yellow_1.set_mortage_price(130);
        ...
        yellow_2.set_house_price(150);
        yellow_2.set_mortage_price(130);
        ...
        yellow_3.set_house_price(150);
        yellow_3.set_mortage_price(140);
        ...
        green_1.set_house_price(200);
        green_1.set_mortage_price(150);
        ...
        green_2.set_house_price(200);
        green_2.set_mortage_price(150);
        ...
        green_3.set_house_price(200);
        green_3.set_mortage_price(160);
        ...
        blue_1.set_house_price(200);
        blue_1.set_mortage_price(175);
        ...
        blue_2.set_house_price(200);
        blue_2.set_mortage_price(200);
